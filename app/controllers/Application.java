...
public class Application extends Controller {
    ...
    public static Result calculation(String symbol) throws ScriptException {
        if (symbol==""){
            string ="";
            return ok(index.render(string));
        }
        else{
            if (symbol.equals("d")){
                string =string+"/";
                ...
                String val = calculateExpression(string).toString() ;
                string="";
                return ok(index.render(val));
            }
            else {
